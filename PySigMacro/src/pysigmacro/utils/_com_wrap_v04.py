...
class COMWrapper:
    ...
    def __call__(self, key, *args, **kwargs):
        try:
            ...
            raise TypeError("COMWrapper object is not callable") from e
...
#                 return result
#             else:
#                 raise AttributeError("No 'Item' method available")
#         except Exception as e:
#             raise TypeError("COMWrapper object is not subscriptable") from e
...
#                 return result
#             else:
#                 raise AttributeError("This COMWrapper object has no callable 'Item' method")
#         except Exception as e:
#             raise TypeError("COMWrapper object is not callable") from e
