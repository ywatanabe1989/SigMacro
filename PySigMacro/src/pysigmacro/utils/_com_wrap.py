#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Timestamp: "2025-03-15 01:04:28 (ywatanabe)"
...
class COMWrapper:
    ...
    def _create_property(self, name, typ):
        ...
        if typ == "Property":
            def getter(instance):
                try:
                    # using getattr here will trigger COM property access
            ...
            def getter(instance):
                try:
                    # Cache the wrapped object to avoid re-instantiation
                    ...
                    # using getattr here will trigger COM object property access
